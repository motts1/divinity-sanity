...
class ImageInput extends _react.default.PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "renderDropDownMenuItem", item => {
      ...
      var Icon = item.icon || _imageIcon.default;
      return _react.default.createElement("div", {
        className: _ImageInput.default.selectDropDownAssetSourceItem
      }, _react.default.createElement("div", {
        className: _ImageInput.default.selectDropDownAssetSourceIcon
      }, _react.default.createElement(Icon, null)), _react.default.createElement("div", null, item.title));
    });
  ...
  renderUploadState(uploadState) {
    ...
    }, _react.default.createElement("div", null, _react.default.createElement("div", null, _react.default.createElement(_circle.default, {
  ...
  render() {
    ...
    return _react.default.createElement(FieldSetComponent, _extends({
      markers: markers,
      legend: type.title,
    ...
    }, uploadProps), uploadError && _react.default.createElement(_default3.default, {
      kind: "error",
      isPersisted: true,
      actionTitle: "OK",
      ...
      title: "Upload error",
      subtitle: _react.default.createElement("div", null, "We're", " really sorry, but the upload could not be completed.")
    }), _react.default.createElement("div", {
      ...
      reference: value.asset,
      materialize: materialize
    }, this.renderMaterializedAsset) : readOnly ? _react.default.createElement("span", null, "Field is read only") : SUPPORT_DIRECT_UPLOADS && _react.default.createElement(_UploadPlaceholder.default, {
      hasFocus: hasFocus
    }))), _react.default.createElement("div", {
      className: _ImageInput.default.functions
    }, _react.default.createElement(_buttonGrid.default, null, !readOnly && SUPPORT_DIRECT_UPLOADS && _react.default.createElement(_button.default, {
      icon: _uploadIcon.default,
      inverted: true,
      onSelect: this.handleSelectFile,
      accept: accept
    }, "Upload"), !readOnly && this.renderSelectImageButton(), showAdvancedEditButton && _react.default.createElement(_default.default, {
    ...
    }, this.renderFields(highlightedFields)), isAdvancedEditOpen && this.renderAdvancedEdit(otherFields), selectedAssetSource && this.renderAssetSource());
  }
